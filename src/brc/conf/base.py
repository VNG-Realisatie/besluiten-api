...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "brc"),
        "USER": os.getenv("DB_USER", "brc"),
        "PASSWORD": os.getenv("DB_PASSWORD", "brc"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "brc.utils.context_processors.settings",
            ],
...
DEFAULT_FROM_EMAIL = "brc@example.com"
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "brc.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
    ...
    "loggers": {
        "brc": {"handlers": ["project"], "level": "INFO", "propagate": True},
...
AUTHENTICATION_BACKENDS = [
    "brc.accounts.backends.UserModelEmailBackend",
